...
abstract class RegisterModule {
  ...
  DeviceStatusRemoteDataSource get deviceStatusRemoteDataSource =>
      DeviceStatusRemoteDataSource(GraphQLConfig());

  @LazySingleton(as: IDeviceGroupStatusRemoteDataSource)
  DeviceGroupStatusRemoteDataSource get deviceGroupStatusRemoteDataSource =>
      DeviceGroupStatusRemoteDataSource(GraphQLConfig());

  @LazySingleton(as: BleLocalDataSource)
  BleLocalDataSourceImpl get bleLocalDataSource => BleLocalDataSourceImpl();
}
