...
class GetDeviceGroupsUseCase
    implements UseCase<DataState<List<DeviceGroupEntity>>, void> {
  final IDeviceGroupRepository _repository;

  GetDeviceGroupsUseCase(this._repository);

  @override
  Future<DataState<List<DeviceGroupEntity>>> execute([void params]) async {
    return await _repository.getDeviceGroups();
  }
}
